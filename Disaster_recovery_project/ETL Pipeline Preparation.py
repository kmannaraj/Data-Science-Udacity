...
### check each column of the categories dataframe are  only 0's and 1's
for column in categories:
...
# All values in the child_alone colomn is 0 , so this attribute does n't have any impact on data set , it is better to drop the column
...
# ### Explore messages with a "related" value of 2
